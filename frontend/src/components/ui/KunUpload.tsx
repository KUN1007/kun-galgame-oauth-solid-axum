...
export const KunUpload: Component<KunUploadProps> = (allProps) => {
  ...
  return (
    <input
      ...
      class={cn(
        'file:bg-default-200 file:text-foreground hover:file:bg-default-300 block w-full text-sm file:mr-4 file:rounded-md file:border-0 file:px-4 file:py-2 file:text-sm file:font-semibold',
        props.class
      )}
